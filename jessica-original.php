...
<?php get_header(); ?>
	...
	<div id="content">
	<div id="contentbg">
<?php $my_query = new WP_Query('showposts=1&author=2'); ?><?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
			<div class="post" id="post-<?php the_ID(); ?>">
				...
				<div class="postentry">
							...
							the_post_thumbnail(array(550,386));
						} else {
...
<?php
	...
	$test = $wpdb->get_var("SELECT ID from $wpdb->posts WHERE post_author=2 AND post_type = 'post' AND post_status = 'publish' ORDER BY post_date DESC LIMIT 1");
	$args = array(
